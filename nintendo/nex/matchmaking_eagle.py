...
class MatchmakeRefereeStartRoundParam(common.Structure):
	...
	def __key(self):
		return (self.personal_data_category, self.gid, self.pids, self.report_summary_mode, self.event_id, )
...
class MatchmakeRefereePersonalRoundResult(common.Structure):
	...
	def __key(self):
		return (self.pid, self.personal_round_result_flag, self.round_win_loss, self.rating_value_change, self.buffer, self.report_summary_mode, self.event_id, )
